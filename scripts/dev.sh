...
if ! command -v air &> /dev/null; then
    print_warning "Air is not installed. Trying to install air for Go hot reloading..."
    go install github.com/air-verse/air@latest
    if [ $? -ne 0 ]; then
        print_warning "Failed to install air automatically. You can:"
        print_warning "1. Install air manually: go install github.com/air-verse/air@latest"
...
print_status "⚡ Both Go and React files will auto-rebuild with Air"
